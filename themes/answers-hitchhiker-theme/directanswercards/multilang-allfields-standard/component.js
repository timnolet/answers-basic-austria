...
class multilang_allfields_standardComponent extends BaseDirectAnswerCard['multilang-allfields-standard'] {
  ...
  dataForRender(type, answer, relatedItem) {
    ...
    return {
      ...
      // },
      footerTextOnSubmission: {{ translateJS phrase='Danke für Ihre Rückmeldung!' }}, // Text to display in the footer when a thumbs up/down is clicked
      footerText: {{ translateJS phrase='War das die Antwort, die Sie gesucht haben?' }}, // Text to display in the footer
